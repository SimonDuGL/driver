...
*/
/**************************************************************************/
boolean Adafruit_VL53L0X2::begin(uint8_t i2c_addr, boolean debug, TwoWire *i2c,
...
*/
/**************************************************************************/
boolean Adafruit_VL53L0X2::setAddress(uint8_t newAddr) {
  newAddr &= 0x7F;
...
*/
/**************************************************************************/
boolean Adafruit_VL53L0X2::configSensor(VL53L0X_Sense_config_t vl_config) {
...
*/
/**************************************************************************/
VL53L0X_Error Adafruit_VL53L0X2::getSingleRangingMeasurement(
...
*/
/**************************************************************************/
VL53L0X_Error Adafruit_VL53L0X2::startMeasurement(boolean debug) {
  VL53L0X_Error Status = VL53L0X_ERROR_NONE;
...
*/
/**************************************************************************/
VL53L0X_Error Adafruit_VL53L0X2::stopMeasurement(boolean debug) {
  VL53L0X_Error Status = VL53L0X_ERROR_NONE;
  if (Status == VL53L0X_ERROR_NONE) {
...
*/
/**************************************************************************/
VL53L0X_Error Adafruit_VL53L0X2::getLimitCheckCurrent(
...
*/
/**************************************************************************/
VL53L0X_Error Adafruit_VL53L0X2::setDeviceMode(VL53L0X_DeviceModes DeviceMode,
                                              boolean debug) {
  VL53L0X_Error Status = VL53L0X_ERROR_NONE;
  if (Status == VL53L0X_ERROR_NONE) {
...
*/
/**************************************************************************/
VL53L0X_Error Adafruit_VL53L0X2::setInterruptThresholds(
...
/**************************************************************************/
VL53L0X_Error
Adafruit_VL53L0X2::getInterruptThresholds(FixPoint1616_t *pThresholdLow,
...
*/
/**************************************************************************/
VL53L0X_Error Adafruit_VL53L0X2::getDeviceMode(VL53L0X_DeviceModes *pDeviceMode,
                                              boolean debug) {
  VL53L0X_Error Status = VL53L0X_ERROR_NONE;
  if (Status == VL53L0X_ERROR_NONE) {
...
*/
/**************************************************************************/
VL53L0X_Error Adafruit_VL53L0X2::clearInterruptMask(boolean debug) {
  VL53L0X_Error Status = VL53L0X_ERROR_NONE;
  if (Status == VL53L0X_ERROR_NONE) {
...
*/
/**************************************************************************/
VL53L0X_Error Adafruit_VL53L0X2::setGpioConfig(
...
*/
/**************************************************************************/
VL53L0X_Error Adafruit_VL53L0X2::getGpioConfig(
...
*/
/**************************************************************************/
VL53L0X_Error Adafruit_VL53L0X2::getRangingMeasurement(
    VL53L0X_RangingMeasurementData_t *RangingMeasurementData, boolean debug) {
  VL53L0X_Error Status = VL53L0X_ERROR_NONE;
  FixPoint1616_t LimitCheckCurrent;
...
*/
/**************************************************************************/
void Adafruit_VL53L0X2::printRangeStatus(
...
uint16_t Adafruit_VL53L0X2::readRange(void) {
...
uint8_t Adafruit_VL53L0X2::readRangeStatus(void) { return _rangeStatus; }
...
boolean Adafruit_VL53L0X2::startRange(void) {
...
boolean Adafruit_VL53L0X2::isRangeComplete(void) {
...
boolean Adafruit_VL53L0X2::waitRangeComplete(void) {
...
uint16_t Adafruit_VL53L0X2::readRangeResult(void) {
  VL53L0X_RangingMeasurementData_t measure; // keep our own private copy
...
*/
/**************************************************************************/
boolean Adafruit_VL53L0X2::startRangeContinuous(uint16_t period_ms) {
  /* This function will do a complete single ranging
   * Here we fix the mode! */
  // first lets set the device in SINGLE_Ranging mode
...
*/
/**************************************************************************/
void Adafruit_VL53L0X2::stopRangeContinuous(void) {
...
/**************************************************************************/
boolean
Adafruit_VL53L0X2::setMeasurementTimingBudgetMicroSeconds(uint32_t budget_us) {
...
*/
/**************************************************************************/
uint32_t Adafruit_VL53L0X2::getMeasurementTimingBudgetMicroSeconds() {
  uint32_t budget_us;
  Status =
...
/**************************************************************************/
boolean
Adafruit_VL53L0X2::setVcselPulsePeriod(VL53L0X_VcselPeriod VcselPeriodType,
...
/**************************************************************************/
uint8_t
Adafruit_VL53L0X2::getVcselPulsePeriod(VL53L0X_VcselPeriod VcselPeriodType) {
  uint8_t cur_period;
 ...
 */
/**************************************************************************/
boolean Adafruit_VL53L0X2::setLimitCheckEnable(uint16_t LimitCheckId,
 ...
 */
/**************************************************************************/
uint8_t Adafruit_VL53L0X2::getLimitCheckEnable(uint16_t LimitCheckId) {
...
boolean Adafruit_VL53L0X2::setLimitCheckValue(uint16_t LimitCheckId,
 ...
 */
/**************************************************************************/
FixPoint1616_t Adafruit_VL53L0X2::getLimitCheckValue(uint16_t LimitCheckId) {
