...
//constructor
// This RTP implement inherits from ompl::base::planner class
...
ompl::base::PlannerStatus ompl::geometric::RTP::solve(const base::PlannerTerminationCondition &ptc)
{
    ...
    while (!ptc)
    {
        ...
        //nmotion->state, meaning the state of the existing tree node picked above
        {
    ...
    //si_->freeState(xstate);//x is the state of the intermediate node
